    ...
    <div className="min-h-screen bg-slate-50">
      <Breadcrumbs 
        items={[
          ...
          { label: 'Site Search', href: '/best-practices/site-search' }
        ]} 
      />
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <Alert className="border-amber-300 bg-amber-50">
            ...
            <AlertDescription>
              <strong>Critical:</strong> Search pages are one of the biggest crawl trap risks on e-commerce sites. 
              Every query creates a unique URL, leading to infinite combinations that can consume your entire crawl budget.
            </AlertDescription>
          </Alert>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <CardContent className="space-y-3">
                ...
                <Alert className="border-red-300 bg-red-50">
                  <AlertDescription className="text-xs">
                    <strong>Impact:</strong> Crawlers can waste weeks discovering and crawling search variations, 
                    never reaching your actual product pages.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-orange-300">
              ...
              <CardContent className="space-y-3">
                ...
                <Alert className="border-orange-300 bg-orange-50">
                  <AlertDescription className="text-xs">
                    <strong>Risk:</strong> Google sees duplicate content and may choose the wrong URL to index, 
                    or worse, penalize your site for excessive duplication.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="bg-amber-50 p-3 rounded border border-amber-200 text-xs space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="text-amber-700">→ Results change as products go in/out of stock</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-red-300">
              ...
              <CardContent className="space-y-3">
                ...
                <Alert className="border-red-300 bg-red-50">
                  <AlertDescription className="text-xs">
                    <strong>Bottom Line:</strong> For large sites, search pages can consume 80%+ of crawl budget 
        ...
        <div className="mb-12">
            ...
            <CardContent className="space-y-4">
              ...
              <Alert className="border-green-300 bg-green-50">
                ...
                <AlertDescription className="text-sm">
                  <strong>Key Insight:</strong> We want crawlers to <em>access</em> search pages (to find products), 
                  but we don't want them to <em>index</em> search pages (because they're low-value URLs).
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-blue-300">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-slate-700">
                Unlike other noindex pages, search pages should use <strong>self-referencing canonicals</strong> that 
              ...
              <Alert className="border-blue-300 bg-blue-50">
                <Info className="h-4 w-4" />
                <AlertDescription className="text-xs">
                  <strong>Why keep the query?</strong> Since search pages are already noindex, there's no duplication risk. 
                  Keeping the query parameter preserves context for analytics and maintains URL structure consistency.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
        ...
        <div className="mb-12">
          ...
          <Alert className="border-red-300 bg-red-50 mb-6">
            <AlertTriangle className="h-4 w-4" />
            <AlertDescription>
              <strong>Common Mistake:</strong> Many developers think blocking <code className="bg-red-100 px-1 rounded text-xs">Disallow: /search</code> in 
            ...
            <Card className="border-2 border-red-300 bg-red-50">
              ...
              <CardContent className="space-y-3">
                <div className="bg-slate-900 text-red-400 p-3 rounded text-xs font-mono space-y-1">
                  ...
                  <div>User-agent: *</div>
                  <div className="text-red-400 font-bold">Disallow: /search   # ❌ DON'T DO THIS</div>
                </div>
                ...
                <Alert className="border-red-400 bg-red-50">
                  <AlertDescription className="text-xs">
                    <strong>Bottom Line:</strong> Blocking prevents the good (product discovery) to avoid the bad (search indexing). 
            ...
            <Card className="border-2 border-green-300 bg-green-50">
              ...
              <CardContent className="space-y-3">
                ...
                <Alert className="border-green-400 bg-green-50">
                  <AlertDescription className="text-xs">
                    <strong>Best of Both:</strong> Crawlers discover products (good), but don't index search pages (also good).
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
          ...
          <Card className="bg-white border-2">
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <p className="font-semibold text-sm mb-3 text-red-700">❌ With robots.txt Blocking</p>
          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-slate-900 text-green-400 p-4 rounded-lg text-xs font-mono space-y-1 overflow-x-auto">
                ...
                <div className="pl-2 text-slate-400 mt-2">{'<!-- Critical: noindex,follow -->'}</div>
                <div className="pl-2 text-yellow-400">{'<meta name="robots" content="noindex,follow" />'}</div>
                <div className="pl-2 text-slate-400 mt-2">{'<!-- Self-referencing canonical with query -->'}</div>
                <div className="pl-2 text-cyan-400">{'<link rel="canonical" href="https://example.com/search?q=shoes" />'}</div>
                <div className="pl-2 text-slate-400 mt-2">{'<!-- Optional: Help search engines understand this is search -->'}</div>
                <div className="pl-2">{'<meta name="description" content="Search results for: shoes" />'}</div>
                <div className="text-slate-400">{'</head>'}</div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-3">
                <Alert className="border-green-300 bg-green-50">
                  <AlertDescription className="text-xs">
                    <strong>1. noindex,follow</strong><br />
                    Prevents indexing, allows discovery
                  </AlertDescription>
                </Alert>
                <Alert className="border-blue-300 bg-blue-50">
                  <AlertDescription className="text-xs">
                    <strong>2. Self-canonical</strong><br />
                    Keeps query in URL
                  </AlertDescription>
                </Alert>
                <Alert className="border-purple-300 bg-purple-50">
                  <AlertDescription className="text-xs">
                    <strong>3. No robots.txt block</strong><br />
                    Allow crawling
                  </AlertDescription>
                </Alert>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded p-4 space-y-3">
                ...
                <ol className="text-xs text-slate-700 space-y-2 list-decimal list-inside">
                  ...
                  <li>Add parameter: <code className="bg-blue-100 px-1 rounded">q</code></li>
                  <li>Select: <strong>"Representative URL: Let Googlebot decide"</strong></li>
                  <li>Or select: <strong>"No URLs: Doesn't affect page content"</strong></li>
                </ol>
              </div>
              ...
              <Alert className="border-blue-300 bg-blue-50">
                <Info className="h-4 w-4" />
                <AlertDescription className="text-xs">
                  <strong>Note:</strong> This is optional since meta noindex already handles it, but it provides 
                  an extra signal to Google about parameter handling.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
        ...
        <div className="mb-12">
          ...
          <Alert className="border-amber-300 bg-amber-50 mb-6">
            <AlertTriangle className="h-4 w-4" />
            <AlertDescription>
              <strong>Warning:</strong> 99% of sites should NOT index search pages. Only consider this for 
              very specific, high-volume branded queries with custom content.
            </AlertDescription>
          </Alert>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">
                      Example: Target.com indexing <code className="bg-slate-100 px-1 rounded">/search?q=nintendo+switch</code> 
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-4 border-red-500 bg-red-50 p-4">
              <p className="font-semibold text-sm mb-1">❌ Using noindex,nofollow (instead of noindex,follow)</p>
              <p className="text-xs text-slate-700">
                The <code className="bg-red-100 px-1 rounded">nofollow</code> prevents link discovery. Always use <code className="bg-green-100 px-1 rounded">follow</code>.
              </p>
            </div>

            <div className="border-l-4 border-red-500 bg-red-50 p-4">
              <p className="font-semibold text-sm mb-1">❌ Indexing all search results (index,follow)</p>
              <p className="text-xs text-slate-700">
            ...
            <div className="border-l-4 border-red-500 bg-red-50 p-4">
              <p className="font-semibold text-sm mb-1">❌ Linking to search from main navigation</p>
              <p className="text-xs text-slate-700">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>Add <code className="bg-slate-100 px-1 rounded text-xs">noindex,follow</code> to ALL search result pages</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
                  <span>Do NOT block <code className="bg-slate-100 px-1 rounded text-xs">/search</code> in robots.txt</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
        ...
        <Card className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-200">
          <CardContent className="pt-6">
            ...
            <Alert className="mt-4 border-amber-300 bg-amber-50">
              <AlertDescription className="text-xs">
                <strong>Remember:</strong> The goal is to let crawlers discover products through search pages, 
                without wasting crawl budget on indexing the search pages themselves. This is why noindex,follow 
                (NOT robots.txt blocking) is the correct strategy.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
