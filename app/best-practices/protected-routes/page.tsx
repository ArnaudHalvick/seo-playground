    ...
    <div className="min-h-screen bg-slate-50">
      <Breadcrumbs 
        items={[
          ...
          { label: 'Protected Routes', href: '/best-practices/protected-routes' }
        ]} 
      />
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <Alert className="border-blue-300 bg-blue-50">
            ...
            <AlertDescription>
              Protected routes contain user-specific or sensitive data that should never appear in search results. 
              The SEO strategy is simple: <strong>block everything</strong> using defense-in-depth.
            </AlertDescription>
          </Alert>
        </div>
            ...
            <Card className="border-2">
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <code className="bg-slate-100 px-2 py-1 rounded text-xs">/account/settings</code>
                  </div>
                  <div className="flex items-center gap-2">
            ...
            <Card className="border-2">
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <code className="bg-slate-100 px-2 py-1 rounded text-xs">/api/* (non-public)</code>
                  </div>
                  <p className="text-slate-600 mt-3">
                    <strong>Strategy:</strong> noindex,nofollow + robots.txt block
                  </p>
          ...
          <Card>
            <CardContent className="pt-6">
              <Alert className="border-amber-300 bg-amber-50 mb-6">
                ...
                <AlertDescription>
                  <strong>Why three layers?</strong> Defense-in-depth ensures that even if one protection fails (e.g., meta tags not rendered), 
                  other protections (robots.txt) prevent indexation. This is critical for sensitive data.
                </AlertDescription>
              </Alert>
                ...
                <div className="border rounded-lg p-5 bg-white">
                  ...
                  <div className="pl-14 space-y-3">
                    ...
                    <ul className="text-sm text-slate-700 space-y-1 list-disc list-inside">
                      <li><strong>noindex:</strong> Prevents page from appearing in search results</li>
                      <li><strong>nofollow:</strong> Tells crawlers not to follow links (for truly sensitive pages)</li>
                    </ul>
                    <p className="text-xs text-slate-500 mt-2">
                      <strong>Note:</strong> For less sensitive pages like /login, you might use noindex,follow instead.
                    </p>
                  </div>
                </div>
                ...
                <div className="border rounded-lg p-5 bg-white">
                  ...
                  <div className="pl-14 space-y-3">
                    ...
                    <ul className="text-sm text-slate-700 space-y-1 list-disc list-inside">
                      ...
                      <li>Pattern matching with wildcard: <code className="bg-slate-100 px-1 rounded text-xs">/account/</code> blocks all subpaths</li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent className="space-y-2">
                ...
                <ul className="text-sm text-slate-700 space-y-1 list-disc list-inside">
                  <li><strong>Why noindex:</strong> Thin content, no unique value for search engines</li>
                  <li><strong>Why follow:</strong> Allow discovery of linked resources (privacy policy, help docs)</li>
                  <li><strong>Exception:</strong> If login page has rich marketing content, consider index,follow</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent className="space-y-2">
                <p className="text-sm text-slate-700">
                  <strong>Recommendation:</strong> noindex,follow (or noindex,nofollow if very sensitive)
                </p>
                <ul className="text-sm text-slate-700 space-y-1 list-disc list-inside">
          ...
          <Card className="border-2 border-amber-400">
            <CardContent className="pt-6">
              <Alert className="border-amber-400 bg-amber-50 mb-6">
                ...
                <AlertDescription>
                  If you discover protected pages in Google's index, act quickly. Sensitive data in search results is a privacy and security issue.
                </AlertDescription>
              </Alert>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 mb-2">
                      Deploy <code className="bg-slate-100 px-1 rounded text-xs">{'<meta name="robots" content="noindex,nofollow" />'}</code> to all protected pages ASAP.
                    </p>
          ...
          <CardContent className="pt-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
                  <span>If already indexed: add noindex immediately, then use removal tool if urgent</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
