...
import { Search, Target, BarChart3, CheckCircle2, Lightbulb, Info } from "lucide-react";

export default function StrategicToolsPageContent() {
  return (
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-slate-700 leading-relaxed">
            Essential tools for keyword research, SERP analysis, competitive intelligence, and
            performance tracking. These tools power strategic SEO without requiring programming
            skills.
          </p>
        </div>
        ...
        <Card className="mb-8 border-2 border-purple-200">
          ...
          <CardContent>
            <div className="space-y-3 text-slate-700">
              <p>
                <strong>Lean over comprehensive:</strong> A focused toolkit of 5-7 tools you
                actually use beats 20+ tools gathering dust. Choose tools that integrate well and
                export clean data.
              </p>
              <p>
                <strong>Adoption beats capability:</strong> The best tool is the one your team will
                consistently use. Factor in learning curves, UI clarity, and workflow integration
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="border-2 border-purple-100">
              ...
              <CardContent>
                ...
                <p className="text-xs text-slate-600">
                  <strong>Best for:</strong> Comprehensive keyword research with traffic potential
                  estimates
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-purple-100">
              ...
              <CardContent>
                ...
                <p className="text-xs text-slate-600">
                  <strong>Best for:</strong> Validating volumes from paid tools; budget-friendly
                  starter option
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="border-2 border-purple-100">
              <CardHeader>
                ...
                <CardDescription>
                  Batch SERP analysis with content pattern extraction
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-slate-700 mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="border-2 border-purple-100">
              ...
              <CardContent>
                ...
                <p className="text-xs text-slate-600">
                  <strong>Best for:</strong> Understanding what happens after users click from
                  search
                </p>
              </CardContent>
            </Card>
        ...
        <Card className="mb-8 border-2 border-green-200 bg-green-50">
          ...
          <CardContent>
            <p className="text-sm text-green-800 mb-4">
              If you&apos;re building your SEO toolkit from scratch, start with this lean, effective
              stack:
            </p>
          ...
          <CardContent>
            <ul className="space-y-2 text-sm text-blue-800">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <strong>Export everything:</strong> Keep raw data in Google Sheets for historical
                  comparisons and custom analysis
                </div>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-4 w-4 mt-0.5 text-blue-600 flex-shrink-0" />
                <div>
                  <strong>Combine tools:</strong> Use Ahrefs for traffic potential, Thruuu for
                  content patterns, GSC for validation
                </div>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-4 w-4 mt-0.5 text-blue-600 flex-shrink-0" />
                <div>
                  <strong>Schedule regular audits:</strong> Monthly GSC reviews, quarterly tool
                  stack reviews
                </div>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-4 w-4 mt-0.5 text-blue-600 flex-shrink-0" />
                <div>
                  <strong>Train your team:</strong> Tools are only as good as the people using them;
                  invest in training
                </div>
              </li>
            </ul>
