...
export default function SeoDevToolsContent() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50 pb-24 lg:pb-8 lg:pr-96">
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        {/* Hero Section */}
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            <Wrench className="h-10 w-10 text-orange-600" />
            <h1 className="text-4xl font-bold text-slate-900">SEO Dev Tools</h1>
          </div>
              ...
              <ul className="space-y-3">
                <li>
                  ...
                  <span className="text-sm text-slate-700">
                    Desktop crawler for auditing links, titles, and indexation issues
                  </span>
                </li>
                <li>
                  <strong className="text-slate-900">Sitebulb:</strong>{" "}
                  <span className="text-sm text-slate-700">
                    Visual crawler with detailed reports and hreflang validation
                  </span>
                </li>
                <li>
                  <strong className="text-slate-900">JetOctopus:</strong>{" "}
                  <span className="text-sm text-slate-700">
                    Cloud crawler and log analyzer for large sites
                  </span>
                </li>
              </ul>
            </CardContent>
            ...
            <CardContent className="pt-6">
              <ul className="space-y-3">
                <li>
                  ...
                  <span className="text-sm text-slate-700">
                    Built into Chrome DevTools - lab testing for performance, SEO, accessibility
                  </span>
                </li>
                <li>
                  <strong className="text-slate-900">WebPageTest:</strong>{" "}
                  <span className="text-sm text-slate-700">
                    Advanced lab testing with filmstrip view and connection throttling
                  </span>
                </li>
                <li>
                  <strong className="text-slate-900">PageSpeed Insights:</strong>{" "}
                  <span className="text-sm text-slate-700">
                    Combines Lighthouse with real Chrome user data (CrUX)
                  </span>
                </li>
                <li>
                  <strong className="text-slate-900">Google Search Console:</strong>{" "}
                  <span className="text-sm text-slate-700">
                    Core Web Vitals report showing real user performance
                  </span>
                </li>
              </ul>
            </CardContent>
            ...
            <CardContent className="pt-6">
              <ul className="space-y-3">
                <li>
                  ...
                  <span className="text-sm text-slate-700">
                    Headless browser automation to test JavaScript rendering
                  </span>
                </li>
                <li>
                  <strong className="text-slate-900">Chrome DevTools:</strong>{" "}
                  <span className="text-sm text-slate-700">
                    Network/Performance/Coverage panels for debugging render-blocking resources
                  </span>
                </li>
                <li>
            ...
            <CardContent className="pt-6">
              <ul className="space-y-3">
                <li>
                  ...
                  <span className="text-sm text-slate-700">
                    Modern hosting with automatic deployments and preview URLs
                  </span>
                </li>
                <li>
                  <strong className="text-slate-900">GitHub Actions:</strong>{" "}
                  <span className="text-sm text-slate-700">
                    CI/CD pipelines - run Lighthouse CI to catch performance regressions
                  </span>
                </li>
                <li>
                  <strong className="text-slate-900">Cloudflare:</strong>{" "}
                  <span className="text-sm text-slate-700">
                    Edge workers for redirects, caching headers, and security rules
                  </span>
                </li>
                <li>
                  <strong className="text-slate-900">Sentry / Datadog:</strong>{" "}
                  <span className="text-sm text-slate-700">
                    Error tracking and APM for production monitoring
                  </span>
                </li>
              </ul>
            </CardContent>
            ...
            <CardContent className="pt-6">
              <ul className="space-y-3">
                ...
                <li>
                  ...
                  <span className="text-sm text-slate-700">
                    Command-line tools to test headers and redirect chains
                  </span>
                </li>
              </ul>
            </CardContent>
          ...
          <Alert className="bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-300">
            ...
            <AlertDescription>
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                <li>
                  <strong>Crawl:</strong> Screaming Frog (free tier) + Puppeteer
                </li>
                <li>
                  <strong>Performance:</strong> Lighthouse + WebPageTest + GSC Core Web Vitals
                </li>
                <li>
                  <strong>Deploy:</strong> GitHub Actions + Vercel/Netlify
                </li>
                <li>
                  <strong>Edge:</strong> Cloudflare for redirects and caching
                </li>
                <li>
                  <strong>Errors:</strong> Sentry free tier
                </li>
              </ul>
            </AlertDescription>
          </Alert>
